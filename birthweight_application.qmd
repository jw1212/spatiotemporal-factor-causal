...
p_bw_mean_maps_combined <- wrap_plots(p_bw_mean_maps, ncol = length(years_show)) +
  plot_layout(guides = "collect") +
  plot_annotation(
    title = "Estimated Mean Birthweight by ZIP Code (ZCTA)"
  ) &
  theme(legend.position = "right")
p_bw_mean_maps_combined

# Optional save
# ggsave("birthweight_mean_maps_2018_2024.pdf",
#        p_bw_mean_maps_combined,
